...
- [x] Research official API docs, operational problems, and duplication risk.
- [x] Create 15 candidate agent jobs and eliminate to six.
- [x] Implement reusable agent loop, registry, budgets, cache, provenance, approval, and mock provider.
